const NODES = [
  ...
  {id:'creon', name:'Creon', epithet:'Regent of Thebes (Brother of Jocasta)', fate:'Loses Wife & Son; Reigns On, Broken', kind:'coral regent', gen:3.5, row:4, pinAfter:'oedipus', pinSide:'left', succFrom:'laius',
